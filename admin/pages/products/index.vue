                    ...
                    <div class="a-section">
                        ...
                        <form>
                            ...
                            <div class="a-spacing-top-medium">
                                ...
                                <textarea placeholder="provide the description of the product" style="width: 100%;"
                                    v-model="description">
                                </textarea>
                            </div>
                            ...
                            <div class="a-spacing-top-large">
                                <span class="a-button-register">
                                    <span class="a-button-inner">
                                        <span class="a-button-text" @click="onAddproduct">Add a new product</span>
                                    </span>
...
export default {
    ...
    async asyncData({ $axios }) {
        try {
            ...
            const [responseCat, responseOwner] = await Promise.all([
                categories,
                owners
            ])
    ...
    methods: {
        ...
        async onAddproduct() {
            ...
            let result=await this.$axios.$post('http://localhost:5001/products',data);
            this.$router.push('/')
