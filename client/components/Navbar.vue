                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5 col-md-4 col-sm-6 p-0">
                        <div class="nav-fill">
                            ...
                            <div class="nav-xshop-container">
                                <div class="nav-xshop">
                                    <a href="#" class="nav-a">Today's deals
                                    </a>
                                    <a href="#" class="nav-a">
                                        Your amazon.com
                                    </a>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                        <div class="nav-tools">
                            ...
                            <nuxt-link to="/register" class="nav-a nav-a-2" id="nav-link-accountList">
                            ...
                            <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                                <span 
                               aria-hidden="true" class="nav-line-1"></span>
                               <span 
                               aria-hidden="true" class="nav-line-2">Cart</span>
                               <span 
                               class="nav-cart-icon nav-sprite"></span>
                               <span aria-hidden="true" 
                               id="nav-cart-count"
                               class="nav-cart-count nav-cart-0">0</span>
                            </nuxt-link>
                        </div>
                    </div>
                </div>
